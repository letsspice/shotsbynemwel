        ...
        <div className="max-w-[1238px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-10 mb-8">
            ...
            <div className="flex items-center gap-6">
              <Link href="https://www.instagram.com/shotbynemwel/" className="text-offwhite hover:text-accent-green transition-colors" aria-label="Instagram" target="_blank">
                <Instagram size={20} />
              </Link>
              <Link href="https://www.tiktok.com/@shotsbynemwel" className="text-offwhite hover:text-accent-green transition-colors" aria-label="TikTok" target="_blank">
          ...
          {/* Divider */}
          <div className="w-full h-[1px] bg-border opacity-30 mb-8" />
